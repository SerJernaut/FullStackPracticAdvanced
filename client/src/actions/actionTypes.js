export default {
    ...
    SEND_EMAIL_FOR_RESET_PASSWORD_REQUEST: 'SEND_EMAIL_FOR_RESET_PASSWORD_REQUEST',
    SEND_EMAIL_FOR_RESET_PASSWORD_SUCCESS: 'SEND_EMAIL_FOR_RESET_PASSWORD_SUCCESS',
    SEND_EMAIL_FOR_RESET_PASSWORD_ERROR: 'SEND_EMAIL_FOR_RESET_PASSWORD_ERROR',
    ...
    GET_MODERATION_OFFERS_REQUEST: 'GET_MODERATION_OFFERS_REQUEST',
    GET_MODERATION_OFFERS_SUCCESS: 'GET_MODERATION_OFFERS_SUCCESS',
    GET_MODERATION_OFFERS_ERROR: 'GET_MODERATION_OFFERS_ERROR',
    OFFER_MODERATION_RESOLVING_REQUEST: 'OFFER_MODERATION_RESOLVING_REQUEST',
    OFFER_MODERATION_RESOLVING_SUCCESS: 'OFFER_MODERATION_RESOLVING_SUCCESS',
    OFFER_MODERATION_RESOLVING_ERROR: 'OFFER_MODERATION_RESOLVING_ERROR',
    OFFER_MODERATION_REJECTING_REQUEST: 'OFFER_MODERATION_REJECTING_REQUEST',
    OFFER_MODERATION_REJECTING_SUCCESS: 'OFFER_MODERATION_REJECTING_SUCCESS',
    OFFER_MODERATION_REJECTING_ERROR: 'OFFER_MODERATION_REJECTING_ERROR',
    NEW_EVENT_ACTION: 'NEW_EVENT_ACTION',
    INCREMENT_NUMBER_OF_ACTIVE_EVENTS_ACTION: 'INCREMENT_NUMBER_OF_ACTIVE_EVENTS_ACTION'
}